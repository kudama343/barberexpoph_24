...
const HomePage: React.FC = () => {
  return (
    <div className="">
     ...
     <Link
      href="/"
      className="bg-[#3a3a3a] text-white text-center py-3 px-6 rounded-lg shadow-md hover:bg-gray-950 hover:text-white transition duration-300 "
    >
      EXCLUSIVE WORKSHOPS:
    </Link>
     <Link
      href="/masterclass"
      className="bg-white text-black text-center py-3 px-6 rounded-lg shadow-md hover:bg-gray-950 hover:text-white transition duration-300 font-montserrat-bold"
    >
