...
const EliteClassPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="min-h-full w-full h-screen bg-contain bg-no-repeat bg-center bg-black bg-[url('/images/EliteClass/MobileV22_2.png')] flex flex-col items-center px-0 sm:px-4 relative">
      <button
